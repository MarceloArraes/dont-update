  ...
  return (
    <div className="flex h-full w-full items-center justify-center bg-blue-600 p-8 text-white">
      <div className="text-center">
        ...
        <p className="mb-4 text-xl">Your PC ran into a problem and needs to restart.</p>
        <p className="mb-4">We're just collecting some error info, and then we'll restart for you.</p>
        ...
        <p className="mt-8 text-lg font-bold">Your computer broke and also we will spy on you with AI. (it's a joke)</p>
      </div>
    </div>
  )
}
